...
class ConexaoBD {
  ...
  function mysql2table($query,$model='',$decode='false'){
    ...
    function mysql_insert($tabela, $dados,$duplicate_key='') {
       ...
       $qtd = count($dados);
        ...
        $status = mysql_query($this->query) or die("Nao foi possivel inserir o registro na base: " . $this->query);
    ...
    function mysql_delete($tabela, $where) {
        ...
        return mysql_query($this->query) or die(0);
    }
