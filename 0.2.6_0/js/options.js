 ...
 */
	var element = {},
		...
		vars = [
					...
					'lang_voices', 'irate','options_title', 'logo', 'app_logo'
				];
/*
 * ---------------------------------------------------------------------------------------------------------------------
...
function init_listeners()
{
	...
	{
		element.irateps.innerHTML = 'x'+parseFloat(this.value).toFixed(2);
		element.iwords.innerHTML = Math.round(this.value*150);
		save_options();
	}, false);
}
/*
...
function restore_options()
{
	...
	element.options_title.innerHTML = 'SpeakIt! v'+getVersion();
	...
	element.iwords.innerHTML = 150*irate.value;
